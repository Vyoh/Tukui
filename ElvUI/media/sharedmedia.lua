...
LSM:Register("font","Pixelated", [[Interface\AddOns\ElvUI\media\fonts\Pixelated.ttf]])
...
LSM:Register("sound", "Hey, Listen!", [[Interface\AddOns\ElvUI\media\sounds\listen.mp3]])